            ...
            <div class="row gy-4">
              ...
              <div class="col-md-6">
                <div class="info-item" data-aos="fade" data-aos-delay="400">
                  ...
                  <h3>Email Us</h3>
                  <p>bkpsdm@metrokota.go.id</p>
                  <p>bidanginkabkpsdm@gmail.com</p>
                </div>
              </div><!-- End Info Item -->
              ...
              <div class="col-md-6">
                <div class="info-item" data-aos="fade" data-aos-delay="500">
                  ...
                  <h3>Open Hours</h3>
                  <p>Senin - Kamis</p>
                  <p>7:30 AM - 04:00 PM</p>
                   <p>Jumat</p>
                  <p>7:30 AM - 04:30 PM</p>
                </div>
              </div><!-- End Info Item -->
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          ...
          <div class="footer-contact pt-3">
            <p>Jl. AH Nasution, Imopuro, Kecamatan Metro Pusat, Kota Metro</p>
            <p>Lampung 34124</p>
            <p class="mt-3"><strong>Telp:</strong> <span>(0725) 34567</span></p>
            <p><strong>Email:</strong> <span>bidanginkabkpsdm@gmail.com</span></p>
          </div>
        </div>
